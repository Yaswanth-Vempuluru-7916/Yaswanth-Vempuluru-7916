...
<a href="https://github.com/Yaswanth-Vempuluru-7916/Live_Docs" style="display: inline-block; margin: 10px; transition: transform 0.3s ease-in-out;" onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
  <img src="" alt="Project 1" />
</a>
<a href="https://github.com/Yaswanth-Vempuluru-7916/Promptopia-nextJs" style="display: inline-block; margin: 10px; transition: transform 0.3s ease-in-out;" onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
...
<div align="center" style="color: #e0e0e0; font-style: italic; animation: fadeIn 1s ease-in-out;">
